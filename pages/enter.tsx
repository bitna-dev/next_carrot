...
const Enter: NextPage = () => {
  ...
  return (
    <>
      <Layout title="Enter to Carrot" hasTabBar>
        <div className="px-4">
          <div className="mt-14">
              ...
              <div className="mt-2">
                ...
                {method === "phone" ? (
                  <div className="flex rounded-md shadow-sm">
                    ...
                    <input
                      id="input"
                      className="apperance-none w-full px-3 py-2 border border-gray-300 rounded-r-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                      type="tel"
                      required
                    />
                  </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 gap-3 mt-2">
                <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium hover:bg-gray-50 hover:text-gray-500">
                  <svg
                    className="w-5 h-5"
                    aria-hidden="true"
                    fill="currentColor"
